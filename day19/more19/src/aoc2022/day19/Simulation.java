...
//    }
    ...
    public ResultRecord runAllVersion3(int length) {
        if (length < 3) {
            return new ResultRecord(FAIL, new ArrayList<>());
        }
        ...
        // do it again save bests
        do {

            // run the plan
            int geodes1 = runVersion1(plan);
            if (geodes1 == bestGeodes) {
                bests.add(plan.clone());
            }
        ...
        return new ResultRecord(bestGeodes, bests);
    ...
    public static void main(String[] args) {
        ...
        System.out.println(s.runAllVersion3(4));
    }
